...
official/supported Docker Images found at https://hub.docker.com/r/v8coinpay/v8coind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/v8coinpay/v8coind-develop/ when changing the above text**