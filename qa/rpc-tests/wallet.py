...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 V8 from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 V8 in block rewards plus fees, but
        ...
        # Send 100 V8 with subtract fee from amount
        ...
        # Sendmany 100 V8 with subtract fee from amount
