    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("V8-light"), QVariant("light"));
    ui->theme->addItem(QString("V8-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("V8-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("V8-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("V8-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("V8-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("V8-traditional"), QVariant("trad"));
