    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  v8coin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the V8COIN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 V8, 0.1 V8, 1 V8 and 10 V8 -- sort of like the paper money you use every day.</li> \
