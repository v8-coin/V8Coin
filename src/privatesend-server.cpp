...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all V8COIN related functionality
...
/*
    ...
    allow endless transaction that would bloat V8COIN and make it unusable. To
