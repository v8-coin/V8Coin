...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_88888);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print V8COIN address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "v8coin",               "masternode",             &masternode,             true,  {} },
    { "v8coin",               "masternodelist",         &masternodelist,         true,  {} },
    { "v8coin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "v8coin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "v8coin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "v8coin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
