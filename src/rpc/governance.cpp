...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in v8coin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("v8coin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* V8COIN features */
    { "v8coin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "v8coin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "v8coin",               "gobject",                &gobject,                true,  {} },
    { "v8coin",               "voteraw",                &voteraw,                true,  {} },
