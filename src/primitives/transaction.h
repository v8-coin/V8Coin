...
public:
    ...
    {
        // "Dust" is defined in terms of CTransaction::minRelayTxFee, which has units VV88-per-kilobyte.
        // If you'd pay more than 1/3 in fees to spend something, then we consider it dust.
        // A typical spendable txout is 34 bytes big, and will need a CTxIn of at least 148 bytes to spend
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 1000 VV88 per kB
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 VV88.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in VV88)
        // i.e. 182 * 3 = 546 VV88 with default -minrelaytxfee = minRelayTxFee = 1000 VV88 per kB.
