...
This mechanism has been integrated into Bitcore-Node-V8COIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/v8coinpay/insight-api-v8coin#web-socket-api](https://github.com/v8coinpay/insight-api-v8coin#web-socket-api)
* API: [https://github.com/v8coinpay/insight-api-v8coin#instantsend-transactions](https://github.com/v8coinpay/insight-api-v8coin#instantsend-transactions)
...
By default, the V8COIN Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the V8COIN Core daemon:
