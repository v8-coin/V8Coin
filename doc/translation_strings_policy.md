...
This document provides guidelines for internationalization of the V8COIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `v8coin_en.ts` remains unchanged.
